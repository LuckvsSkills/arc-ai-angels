...
# EXACTE ORIGINELE index.html (v6) - zoals het was voordat we begonnen
...
# Write index.html (EXACTE ORIGINELE v6)
with open(os.path.expanduser('~/arc_ai_angels/website/index.html'), 'w') as f:
    f.write(index_html)

print("✅ index.html TERUGGEZET naar originele v6 layout!")
print("📄 EXACT zoals het was voordat we begonnen met wijzigingen")
print("")
print("Wat je nu hebt:")
print("- index.html: ORIGINELE layout (Hero + 2 kolommen + diagrammen)")
print("- data/progress.json: Bijgewerkt met alle blocks")
print("- chapters/: Wordt niet aangeraakt door dit script")
print("")
print("Draai nu: python3 ~/arc_ai_angels/rebuild_index_v9.py")
print("Refresh daarna: http://172.24.162.255:9000/index.html")
