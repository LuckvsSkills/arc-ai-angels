...
# ORIGINELE index.html (v6 style) - Arc AI Angels compact block + sidebar met blocks
...
graph TD
    ...
    <script>
                ...
                chapters.forEach(chapter => {
                    ...
                    chapterDiv.innerHTML = `
                        ...
                        <div id="blocks-${chapter.id}" class="ml-4 space-y-1 hidden chapter-blocks">
                            <a href="chapters/${chapter.id}.html" class="block-link block p-2 text-xs text-gray-400 hover:text-white rounded flex items-center gap-2 font-medium">
        ...
        function createChapterProgressBlock(chapter, completed, total) {
            ...
            return `
                <div class="chapter-progress-block p-4 rounded-xl cursor-pointer"
                    ...
                    <div class="flex justify-between text-xs text-gray-400">
                        ...
                        <span>${completed === total ? '✓ Compleet' : 'In progress'}</span>
                    </div>
                </div>
            `;
        }
...
# Write index.html (ORIGINELE layout)
with open(os.path.expanduser('~/arc_ai_angels/website/index.html'), 'w') as f:
    f.write(index_html)

# NIEUWE chapter template (met gekleurde blocks, etc.)
...
# Generate chapter pages (NIEUWE layout met gekleurde blocks)
...
# Generate chapters index page (overview) - NIEUWE layout
...
print(f"📄 index.html: TERUG naar originele layout (v6 style)")
print(f"📁 Chapter pages: NIEUWE layout met gekleurde blocks & diagrammen")
print(f"📑 chapters/index.html: NIEUWE overview pagina")
print(f"📊 Data: {len(chapters_data['chapters'])} chapters, {total_blocks} blocks")
print("")
print("Wat is veranderd:")
print("- index.html: Oude werkbare layout (Arc AI Angels compact block + sidebar)")
print("- Chapter pagina's: Gekleurde blocks per hoofdstuk, diagrammen waar van toepassing")
print("- chapters/index.html: Overview met alle chapters & blocks")
print("")
print("Test:")
print("1. Refresh http://172.24.162.255:9000/index.html (oude layout)")
print("2. Klik hoofdstuk in sidebar → blocks klappen uit")
print("3. Klik block → gaat naar chapter pagina met gekleurde blocks")
