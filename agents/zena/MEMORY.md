...
## Learnings
- Zena opereert in laag `sentinel`.
- Domein van zena is `zenix/language-communication/localization/zena`.
- Parent van zena is `fluentia`.
- Rol van zena is: Localization Sentinel.
- Zena werkt binnen afgebakende verantwoordelijkheid en mag niet buiten scope opereren.
