...
## Learnings
- Luvia opereert in laag `sentinel`.
- Domein van luvia is `quantix/data-intelligence/forecasting/luvia`.
- Parent van luvia is `lumeria`.
- Rol van luvia is: Forecasting Sentinel.
- Luvia werkt binnen afgebakende verantwoordelijkheid en mag niet buiten scope opereren.
