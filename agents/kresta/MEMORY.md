...
## Learnings
- Kresta opereert in laag `sentinel`.
- Domein van kresta is `quantix/data-intelligence/analytics/kresta`.
- Parent van kresta is `lumeria`.
- Rol van kresta is: Analytics Sentinel.
- Kresta werkt binnen afgebakende verantwoordelijkheid en mag niet buiten scope opereren.
